...
ggplotly(penguins |> 
  ggplot(aes(x = bill_length_mm, y = flipper_length_mm,
             color = log(d$singlePointContribution))) +
  geom_jitter() +
  scale_color_distiller(type = "div",
                        palette = "Spectral") +
  theme_minimal())
...
ggplotly(penguins |> 
  ggplot(aes(x = bill_length_mm, 
             y = flipper_length_mm)) +
  geom_jitter() +
  geom_point(data = (penguins |> slice(indices)),
...
# Look at the point contributions as they change around as we change the resamples.
```
